...
| REL-104 | high | closed | operations | Confirm no remaining runtime behaviors are visible but not operator-manageable where needed | maintainer | Signed sweep recorded in [`v1-operator-sweep.md`](./v1-operator-sweep.md) | before `v1.0.0` |
...
| REL-104 | 2026-03-24 | Final operator-manageability sweep found no remaining `v1.0` blocker in reviewed admin surfaces | [`docs/v1-operator-sweep.md`](./v1-operator-sweep.md) |
